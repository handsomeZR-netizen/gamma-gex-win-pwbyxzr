...
from app.common.paths import DATA_DIR, GEX_BLACKBOX_DB
...
class MarketVetoCache:
    ...
    def _load_api_key(self) -> str:
        """Load Anthropic API key from environment or local .env."""
    ...
    def _save_cache(self):
        ...
        try:
            os.close(fd)
            with locked_open(temp_path, 'w', exclusive=True) as f:
    ...
    def _get_market_data(self, timestamp, market: str) -> Dict:
        ...
        if timestamp_naive < datetime.now() - timedelta(minutes=10):
            ...
            try:
                ...
                conn = sqlite3.connect(str(GEX_BLACKBOX_DB))
