...
DECISIONS_FILE = str(data_path('entry_decisions.json'))
...
class DecisionLogger:
    ...
    def _read_decisions(self):
        ...
        try:
            with locked_open(self.file, 'r', exclusive=False) as f:
                return json.load(f)
    ...
    def _write_decisions(self, decisions):
        ...
        try:
            ...
            with locked_open(temp_file, 'w', exclusive=True) as f:
    ...
    def clear(self):
        """Clear all decisions."""
        ensure_data_dir()
        with locked_open(self.file, 'w', exclusive=True) as f:
            json.dump([], f)
