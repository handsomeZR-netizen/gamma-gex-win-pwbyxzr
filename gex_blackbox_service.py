...
import os
from app.common.paths import GEX_BLACKBOX_DB, data_path
...
def is_trading_day():
    ...
    # Optional local override file for explicit closures.
    closed_flag = Path(data_path('market_closed.flag'))
