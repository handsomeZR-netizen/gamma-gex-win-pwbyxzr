...
if not DATABENTO_API_KEY:
    ...
    print("  Windows PowerShell: $env:DATABENTO_API_KEY='your_key_here'")
    print("  Linux/macOS: export DATABENTO_API_KEY='your_key_here'")
    sys.exit(1)
...
def download_batch_file(job_id):
    ...
    The FTP path /<DATASET_ID>/<JOB_ID> suggests a batch job.
